...
namespace Application.Features.Models.Profiles
{
    public class MappingProfiles : Profile
    {
        ...
        {            
            ...
            CreateMap<GetListResponse<GetListModelListItemDto>, Paginate<Model>>().ReverseMap();
            CreateMap<GetListResponse<GetListByDynamicModelListItemDto>, Paginate<Model>>().ReverseMap();
        }
    }
}